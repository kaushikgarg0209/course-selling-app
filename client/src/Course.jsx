...
useEffect(() => {
    fetch(`https://course-selling-app-6l4t.onrender.com/admin/courses/${courseId}`, {
        method: 'GET',
        headers: {
...
function UpdateCard(proms) {
    ...
    async function handleClick () {
        ...
        await fetch(`https://course-selling-app-6l4t.onrender.com/admin/courses/${proms.courseId}`, {
        method : "PUT",
        body : JSON.stringify({
            title: title,
